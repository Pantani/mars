...
func init() {
	...
	md_User = File_mars_mars_user_proto.Messages().ByName("User")
...
func (x *User) slowProtoReflect() protoreflect.Message {
	mi := &file_mars_mars_user_proto_msgTypes[0]
...
func (x *fastReflection_User) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mars.mars.User.id":
		return x.Id != uint64(0)
	case "mars.mars.User.email":
		return x.Email != ""
	case "mars.mars.User.creator":
		return x.Creator != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mars.mars.User"))
		}
		panic(fmt.Errorf("message mars.mars.User does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_User) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mars.mars.User does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_User) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "mars.mars.User.id":
		panic(fmt.Errorf("field id of message mars.mars.User is not mutable"))
	case "mars.mars.User.email":
		panic(fmt.Errorf("field email of message mars.mars.User is not mutable"))
	case "mars.mars.User.creator":
		panic(fmt.Errorf("field creator of message mars.mars.User is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mars.mars.User"))
		}
...
func (x *fastReflection_User) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mars.mars.User", d.FullName()))
	}
	panic("unreachable")
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_mars_mars_user_proto_rawDescGZIP(), []int{0}
}
...
var File_mars_mars_user_proto protoreflect.FileDescriptor

var file_mars_mars_user_proto_rawDesc = []byte{
	0x0a, 0x14, 0x6d, 0x61, 0x72, 0x73, 0x2f, 0x6d, 0x61, 0x72, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x6d, 0x61, 0x72, 0x73, 0x2e, 0x6d, 0x61, 0x72,
	0x73, 0x22, 0x46, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	,
}

var (
	file_mars_mars_user_proto_rawDescOnce sync.Once
	file_mars_mars_user_proto_rawDescData = file_mars_mars_user_proto_rawDesc
)

func file_mars_mars_user_proto_rawDescGZIP() []byte {
	file_mars_mars_user_proto_rawDescOnce.Do(func() {
		file_mars_mars_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_mars_mars_user_proto_rawDescData)
	})
	return file_mars_mars_user_proto_rawDescData
}

var file_mars_mars_user_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mars_mars_user_proto_goTypes = []interface{}{
	(*User)(nil), // 0: mars.mars.User
}
var file_mars_mars_user_proto_depIdxs = []int32{
...
func init() { file_mars_mars_user_proto_init() }
func file_mars_mars_user_proto_init() {
	if File_mars_mars_user_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mars_mars_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mars_mars_user_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mars_mars_user_proto_goTypes,
		DependencyIndexes: file_mars_mars_user_proto_depIdxs,
		MessageInfos:      file_mars_mars_user_proto_msgTypes,
	}.Build()
	File_mars_mars_user_proto = out.File
	file_mars_mars_user_proto_rawDesc = nil
	file_mars_mars_user_proto_goTypes = nil
	file_mars_mars_user_proto_depIdxs = nil
}
