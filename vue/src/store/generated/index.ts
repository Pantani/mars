...
import CosmonautMarsCosmonautMarsMars from './cosmonaut/mars/cosmonaut.mars.mars'
...
export default { 
  CosmonautMarsCosmonautMarsMars: load(CosmonautMarsCosmonautMarsMars, 'cosmonaut.mars.mars'),
